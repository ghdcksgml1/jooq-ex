...
import org.jooq.generated.tables.KAddress.AddressPath
import org.jooq.generated.tables.KPayment.PaymentPath
import org.jooq.generated.tables.KRental.RentalPath
import org.jooq.generated.tables.KStore.StorePath
...
open class KCustomer(
    ...
    companion object {
         ...
         */
        val CUSTOMER: KCustomer = KCustomer()
    }
     ...
     */
    open class CustomerPath : KCustomer, Path<CustomerRecord> {
    ...
    override fun `as`(alias: String): KCustomer = KCustomer(DSL.name(alias), this)
    override fun `as`(alias: Name): KCustomer = KCustomer(alias, this)
    override fun `as`(alias: Table<*>): KCustomer = KCustomer(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KCustomer = KCustomer(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KCustomer = KCustomer(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KCustomer = KCustomer(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KCustomer = KCustomer(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KCustomer = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KCustomer = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KCustomer = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KCustomer = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KCustomer = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KCustomer = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KCustomer = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KCustomer = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KCustomer = where(DSL.notExists(select))
}
