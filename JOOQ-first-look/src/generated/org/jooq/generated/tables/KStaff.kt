...
open class KStaff(
     ...
     */
    open class StaffPath : KStaff, Path<StaffRecord> {
    ...
    override fun `as`(alias: String): KStaff = KStaff(DSL.name(alias), this)
    override fun `as`(alias: Name): KStaff = KStaff(alias, this)
    override fun `as`(alias: Table<*>): KStaff = KStaff(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KStaff = KStaff(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KStaff = KStaff(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KStaff = KStaff(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KStaff = KStaff(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KStaff = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KStaff = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KStaff = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KStaff = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KStaff = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KStaff = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KStaff = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KStaff = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KStaff = where(DSL.notExists(select))
}
