...
open class KFilm(
     ...
     */
    open class FilmPath : KFilm, Path<FilmRecord> {
    ...
    override fun `as`(alias: String): KFilm = KFilm(DSL.name(alias), this)
    override fun `as`(alias: Name): KFilm = KFilm(alias, this)
    override fun `as`(alias: Table<*>): KFilm = KFilm(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KFilm = KFilm(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KFilm = KFilm(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KFilm = KFilm(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KFilm = KFilm(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KFilm = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KFilm = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KFilm = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KFilm = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KFilm = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KFilm = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KFilm = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KFilm = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KFilm = where(DSL.notExists(select))
}
