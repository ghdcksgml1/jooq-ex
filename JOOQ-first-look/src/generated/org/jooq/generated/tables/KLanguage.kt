...
open class KLanguage(
    ...
    companion object {
         ...
         */
        val LANGUAGE: KLanguage = KLanguage()
    }
     ...
     */
    open class LanguagePath : KLanguage, Path<LanguageRecord> {
    ...
    override fun `as`(alias: String): KLanguage = KLanguage(DSL.name(alias), this)
    override fun `as`(alias: Name): KLanguage = KLanguage(alias, this)
    override fun `as`(alias: Table<*>): KLanguage = KLanguage(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KLanguage = KLanguage(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KLanguage = KLanguage(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KLanguage = KLanguage(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KLanguage = KLanguage(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KLanguage = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KLanguage = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KLanguage = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KLanguage = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KLanguage = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KLanguage = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KLanguage = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KLanguage = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KLanguage = where(DSL.notExists(select))
}
