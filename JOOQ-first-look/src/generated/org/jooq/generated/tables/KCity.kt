...
import org.jooq.generated.tables.KCountry.CountryPath
...
open class KCity(
     ...
     */
    open class CityPath : KCity, Path<CityRecord> {
    ...
    override fun `as`(alias: String): KCity = KCity(DSL.name(alias), this)
    override fun `as`(alias: Name): KCity = KCity(alias, this)
    override fun `as`(alias: Table<*>): KCity = KCity(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KCity = KCity(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KCity = KCity(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KCity = KCity(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KCity = KCity(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KCity = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KCity = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KCity = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KCity = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KCity = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KCity = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KCity = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KCity = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KCity = where(DSL.notExists(select))
}
