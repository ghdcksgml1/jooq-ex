...
open class KFilmText(
    ...
    companion object {
         ...
         */
        val FILM_TEXT: KFilmText = KFilmText()
    }
    ...
    override fun `as`(alias: String): KFilmText = KFilmText(DSL.name(alias), this)
    override fun `as`(alias: Name): KFilmText = KFilmText(alias, this)
    override fun `as`(alias: Table<*>): KFilmText = KFilmText(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KFilmText = KFilmText(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KFilmText = KFilmText(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KFilmText = KFilmText(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KFilmText = KFilmText(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KFilmText = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KFilmText = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KFilmText = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KFilmText = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KFilmText = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KFilmText = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KFilmText = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KFilmText = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KFilmText = where(DSL.notExists(select))
}
