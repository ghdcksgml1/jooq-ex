...
open class KInventory(
    ...
    companion object {
         ...
         */
        val INVENTORY: KInventory = KInventory()
    }
     ...
     */
    open class InventoryPath : KInventory, Path<InventoryRecord> {
    ...
    override fun `as`(alias: String): KInventory = KInventory(DSL.name(alias), this)
    override fun `as`(alias: Name): KInventory = KInventory(alias, this)
    override fun `as`(alias: Table<*>): KInventory = KInventory(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): KInventory = KInventory(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): KInventory = KInventory(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): KInventory = KInventory(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): KInventory = KInventory(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): KInventory = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): KInventory = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): KInventory = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): KInventory = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): KInventory = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): KInventory = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): KInventory = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): KInventory = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): KInventory = where(DSL.notExists(select))
}
